...
function Card() {
  ...
  <div className='flex justify-center h-52 sm:h-64 md:h-64 lg:h-80  mt-4 '> 
    ...
    <div className="rounded-xl mx-3  bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
    ...
    <div className="rounded-xl mx-3 hidden md:block  shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
    <a href="">
    ...
    <div className="rounded-xl mx-3 hidden xl:block bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
    <a href="">
